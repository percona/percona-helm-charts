...
helm install my-operator percona/pg-operator --version 2.10.0 --namespace my-namespace --create-namespace
```
...
```sh
helm install my-db percona/pg-db --version 2.10.0 --namespace my-namespace
```
