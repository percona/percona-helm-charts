...
helm install my-operator percona/pg-operator --version 2.8.1 --namespace my-namespace --create-namespace
```
...
| -------------------- | ---------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `image`              | PG Operator Container image full path                                              | `docker.io/percona/percona-postgresql-operator:2.8.1` |
