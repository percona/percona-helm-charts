...
helm install my-operator percona/pg-operator --version 3.2.0 --namespace my-namespace --create-namespace
```
...
```sh
helm install my-db percona/pg-db --version 3.2.0 --namespace my-namespace
```
