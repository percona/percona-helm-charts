...
| ----------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| `image`                 | PG Operator Container image full path                                                         | `docker.io/percona/percona-postgresql-operator:2.9.0` |
...
| `leaseName`             | Determines the name of the resource that leader election will use for holding the leader lock | ``                                                    |
| `leaseDuration`         | Duration that non-leader candidates will wait to force acquire leadership                     | `60s`                                                 |
| `renewDeadline`         | Duration that the acting controlplane will retry refreshing leadership before giving up       | `40s`                                                 |
| `retryPeriod`           | Duration the LeaderElector clients should wait between tries of actions                       | `10s`                                                 |
