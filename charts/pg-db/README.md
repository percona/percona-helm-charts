...
helm install my-db percona/pg-db --version 2.5.4 --namespace my-namespace
```
...
| `crVersion`                       | CR Cluster Manifest version                                                                                                                                                                             | `2.5.1`                                                      |
| `repository`                      | PostgreSQL container image repository                                                                                                                                                                   | `percona/percona-postgresql-operator`                        |
| `image`                           | Postgres image                                                                                                                                                                                          | `percona/percona-postgresql-operator:2.5.1-ppg16.8-postgres` |
...
| `backups.pgbackrest.image`                                                         | Set this variable if you need to use a custom pgBackrest image                                                                                           | `percona/percona-postgresql-operator:2.5.1-ppg16.8-pgbackrest2.54.2` |
...
| `proxy.pgBouncer.image`                                               | Set this variable if you need to use a custom pgbouncer image                                                           | `percona/percona-postgresql-operator:2.5.1-ppg16.8-pgbouncer1.24.0` |
