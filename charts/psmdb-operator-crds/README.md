...
helm install psmdb-operator-crds percona/psmdb-operator-crds --version 1.24.0 --namespace psmdb --create-namespace
```
...
```sh
helm install psmdb-operator-crds percona/psmdb-operator-crds --version 1.24.0 --namespace psmdb --create-namespace --set preserveCrds=false
```
...
```sh
helm repo update
helm upgrade psmdb-operator-crds percona/psmdb-operator-crds --version 1.24.0 --namespace psmdb
```
...
```sh
helm upgrade psmdb-operator percona/psmdb-operator --version 1.24.0 --namespace psmdb
```
...
```sh
helm upgrade --install psmdb-operator-crds percona/psmdb-operator-crds --version 1.24.0 --namespace psmdb --take-ownership
```
