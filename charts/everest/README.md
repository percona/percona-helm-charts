...
| operator.env | object | `{}` | Additional environment variables to pass to the operator deployment. |
...
| server.env | object | `{}` | Additional environment variables to pass to the server deployment. |
