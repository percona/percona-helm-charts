...
| `pmmEnv.PMM_ENABLE_TELEMETRY`        | Send [anonymous usage data](https://docs.percona.com/percona-monitoring-and-management/3/configure-pmm/advanced_settings.html#telemetry) to Percona, set to `0` to opt out                                                                                           | `1`                  |
