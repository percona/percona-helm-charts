...
| `image.tag`                          | PMM image tag (immutable tags are recommended)                                                                                                                                                                                                | `3.8.0`             |
...
| `extraEnvFrom`                       | Optionally specify a list of additional envFrom sources (ConfigMaps/Secrets) appended to the PMM container's envFrom                                                                                                                         | `[]`                 |
