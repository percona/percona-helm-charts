...
| `extraLabels.app.kubernetes.io/component` | The component within the architecture                                                                                                                                                  | `pmm-server`          |
| `extraLabels.app.kubernetes.io/part-of`   | The name of a higher level application this one is part of                                                                                                                             | `percona-platform`    |
