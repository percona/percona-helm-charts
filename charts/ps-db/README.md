...
| `mysql.env`                                       | MySQL Pods set env variable                                                                                                                                   | `[]`                       |
| `mysql.envFrom`                                   | MySQL Pods set env variable from secret                                                                                                                       | `[]`                       |
...
| `proxy.router.env`                                    | Router Pods set env variable                                                                                                                                  | `[]`                           |
| `proxy.router.envFrom`                                | Router Pods set env variable from secret                                                                                                                      | `[]`                           |
| `proxy.router.startupProbe`                           | Router Pods livenessProbe structure                                                                                                                           | `{}`                           |
| `proxy.router.livenessProbe`                          | Router Pods livenessProbe structure                                                                                                                           | `{}`                           |
| `proxy.router.readinessProbe`                         | Router Pods readinessProbe structure                                                                                                                          | `{}`                           |
...
| `orchestrator.env`                                       | Orchestrator Pods set env variable                                                                                                                            | `[]`                           |
| `orchestrator.envFrom`                                   | Orchestrator Pods set env variable from secret                                                                                                                | `[]`                           |
| `orchestrator.startupProbe`                              | Orchestrator Pods livenessProbe structure                                                                                                                     | `{}`                           |
| `orchestrator.livenessProbe`                             | Orchestrator Pods livenessProbe structure                                                                                                                     | `{}`                           |
| `orchestrator.readinessProbe`                            | Orchestrator Pods readinessProbe structure                                                                                                                    | `{}`                           |
...
| `pmm.readinessProbe.periodSeconds`        | How often (in seconds) to perform the probe                                                                                                                                                           | `30`                                |
| `pmm.readinessProbe.successThreshold`     | Minimum consecutive successes for the probe to be considered successful after having failed                                                                                                           | `1`                                 |
| `pmm.readinessProbe.timeoutSeconds`       | Number of seconds after which the probe times out                                                                                                                                                     | `15`                                |
| `pmm.livenessProbe.failureThreshold`      | When a probe fails, Kubernetes will try failureThreshold times before giving up                                                                                                                       | `3`                                 |
| `pmm.livenessProbe.initialDelaySeconds`   | Number of seconds after the container has started before liveness or readiness probes are initiated                                                                                                   | `300`                               |
| `pmm.livenessProbe.periodSeconds`         | How often (in seconds) to perform the probe                                                                                                                                                           | `10`                                |
| `pmm.livenessProbe.successThreshold`      | Minimum consecutive successes for the probe to be considered successful after having failed                                                                                                           | `1`                                 |
| `pmm.livenessProbe.timeoutSeconds`        | Number of seconds after which the probe times out                                                                                                                                                     | `5`                                 |
