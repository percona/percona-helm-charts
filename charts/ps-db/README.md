...
| `mysql.volumeSpec.pvc.dataSource.name`            | The name of PVC used as a data source to [create the Percona Operator for MySQL Volumes by cloning](https://kubernetes.io/docs/concepts/storage/volume-pvc-datasource/).               | ``                                | 
| `mysql.volumeSpec.pvc.dataSource.kind`            | The [Kubernetes DataSource type](https://kubernetes-csi.github.io/docs/volume-datasources.html#supported-datasources).                                                                 | ``                                |
| `mysql.volumeSpec.pvc.dataSource.apiGroup`        | The [Kubernetes API group](https://kubernetes.io/docs/reference/using-api/#api-groups) to use for [PVC Data Source](https://kubernetes-csi.github.io/docs/volume-datasources.html).    | ``                                |
| `mysql.volumeSpec.pvc.dataSourceRef.name`            | The name of PVC used as a data source to [create the Percona Operator for MySQL Volumes by cloning](https://kubernetes.io/docs/concepts/storage/volume-pvc-datasource/).            | ``                                | 
| `mysql.volumeSpec.pvc.dataSourceRef.namespace`     | The namespace of PVC used as a data source to [create the Percona Operator for MySQL Volumes by cloning](https://kubernetes.io/docs/concepts/storage/volume-pvc-datasource/).         | ``                                | 
| `mysql.volumeSpec.pvc.dataSourceRef.kind`            | The [Kubernetes DataSource type](https://kubernetes-csi.github.io/docs/volume-datasources.html#supported-datasources).                                                              | ``                                |
| `mysql.volumeSpec.pvc.dataSourceRef.apiGroup`        | The [Kubernetes API group](https://kubernetes.io/docs/reference/using-api/#api-groups) to use for [PVC Data Source](https://kubernetes-csi.github.io/docs/volume-datasources.html). | ``                                |
...
| `orchestrator.image.tag`                                 | Orchestrator Container image tag                                                                                                                              | `3.2.6-17`                     |
